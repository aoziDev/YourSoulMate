...
public class LoginButton extends FrameLayout {
    ...
    private void onClickLoginButton(final boolean canWithTalk, final boolean canWithStory){
        final List<Item> itemList = new ArrayList<Item>();
        if(canWithTalk) itemList.add(new Item(R.string.com_kakao_kakaotalk_account, R.drawable.kakaotalk_icon, AuthType.KAKAO_TALK));
        if(canWithStory) itemList.add(new Item(R.string.com_kakao_kakaostory_account, R.drawable.kakaostory_icon, AuthType.KAKAO_STORY));
            ...
            .setAdapter(adapter, new DialogInterface.OnClickListener() {
                public void onClick(final DialogInterface dialog, final int position) {
                    ...
                    if(authType == null){
                        ...
                        Session.getCurrentSession().open(loginSessionCallback, authType);
                    }
                }
            }).create().show();
