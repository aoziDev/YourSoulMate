...
//                        file1.delete();
    ...
    private void initializeButtons() {
        ...
        // 텍스트만 포스팅
        final Button postTextButton = (Button) findViewById(id.text_post_button);
        ...
        final Button postImageButton = (Button) findViewById(id.image_post_button);
        ...
        final Button postLinkButton = (Button) findViewById(id.link_post_button);
        ...
        // 마지막 포스팅 정보.
        getPostButton = (Button) findViewById(id.get_post_button);
        ...
        // 최근 포스팅 정보.
        getPostsButton = (Button) findViewById(id.get_posts_button);
    ...
    private void initializeProfileView() {
        ...
        // background image
        background = (NetworkImageView) findViewById(id.background);
