...
public class KakaoStoryLoginActivity extends Activity {
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kakaostory_login);
    ...
    private void setCloseButton() {
    	findViewById(R.id.tv_kakaostory_posting_close).setOnClickListener(new OnClickListener() {
			@Override
